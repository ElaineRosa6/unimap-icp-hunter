...
func (r *Router) RegisterRoutes() http.Handler {
	...
	r.addRoute("node-get", "GET", "/api/nodes/get", r.server.handleNodeGet, false)
	r.addRoute("node-deregister", "DELETE", "/api/nodes/deregister", r.server.handleNodeDeregister, false)
